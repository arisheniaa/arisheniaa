...
await section('2. дословность текста', async () => {
  ...
  note(
    RED
      ? !text.includes('я подберу для вас 5–7 кадров из своих реальных съёмок. Раскадровку можно скачать')
      : text.includes('я подберу для вас 5–7 кадров из своих реальных съёмок. Раскадровку можно скачать'),
    'дословно (Ф64): подводка сшита по месту выреза, соседние слова не задеты',
  );
