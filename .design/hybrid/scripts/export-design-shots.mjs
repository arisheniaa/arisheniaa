 ...
 *   · elegia-tula.ru — боевой адрес. Сначала здесь стоял локальный сервер
 *     4173 из соседней папки «ритуал сайт», потому что сайта в сети ещё не
 *     было; владелица выложила его и дала адрес. Боевой адрес вернее
 *     локального по той же причине, что у Алёниного: показывать надо то,
 *     что человек увидит, перейдя по ссылке. Владелица предупредила, что
 *     сайт ещё будет меняться, — пересъёмка стоит одной команды.
 *
