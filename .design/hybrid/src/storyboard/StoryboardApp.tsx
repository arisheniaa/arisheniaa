  ...
  return (
    <div>
      ...
      <p className="t-lead mt-[clamp(1.2rem,3vw,2rem)] max-w-[44ch] text-[color:var(--ink-soft)]">
        ...
        немного вдохновляясь моими уже собранными досками на Pinterest. Раскадровку можно скачать
        и принести с собой в переписку — так проще показать, какую съёмку вы себе представляете.
      </p>
    ...
    <div>
      ...
      {result.occasionOverride && (
        <p className="t-body mt-[0.9rem] max-w-[50ch] text-[color:var(--ink-soft)]">
          Показываю кадры именно с этим поводом. Место и образ в архиве пока не размечены под эти
          кадры, поэтому эти ответы не повлияли — учла только материал.
        </p>
      )}
      ...
      {result.relaxedGender && (
        <p className="t-body mt-[0.9rem] max-w-[50ch] text-[color:var(--ink-soft)]">
          ...
          этому формату, а такие кадры я подняла повыше в выдаче.
        </p>
      )}

      <div className="mt-[clamp(2rem,6vh,3.5rem)]">
        <h3 className="t-h2">Вдохновение по моим съёмкам</h3>
