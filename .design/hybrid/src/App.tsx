      ...
      <div className={WRAP}>
        <div className="grid grid-cols-1 gap-x-[var(--gap)] gap-y-[clamp(1.4rem,3vw,2.4rem)] lg:grid-cols-12">
          <div className="lg:col-span-6 lg:col-start-1">
            {/* Надзаголовок — та же подпись и то же начертание, что у
                единственного `h1` страницы фичи: человек, дошедший по ссылке,
                узнаёт место, куда попал, по той же строке, что видел здесь. */}
            <p className="reveal t-mono text-[color:var(--ink-mute)]">{copy.storyboard.nav}</p>
            <h2 className="reveal t-h1 mt-[0.7rem]" style={{ ['--i' as string]: 1 }}>
        ...
        <div className="reveal mt-[clamp(2rem,5vh,3.4rem)]" style={{ ['--i' as string]: 3 }}>
